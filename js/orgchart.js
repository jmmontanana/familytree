...
(OrgChart._defaultConfig = function (t) {
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, a) {
    ...
    if (
      ...
      for (O = 0; O < f.tags.length; O++) A.classList.add(f.tags[O]);
    (A.style.display = "flex"),
      (A.style.opacity = r ? 1 : 0),
      (A.style.right = r ? 0 : "-20px"),
      i && (A.style.width = i);
    var N = [],
      M = a ? "" : OrgChart.EDITFORM_CLOSE_BTN;
    return (
        ...
        f.menu)) {
          ...
          if ((A.setAttribute("pointer-events", "none"), A)) {
            var N = parseInt(A.getAttribute("width")),
              M = parseInt(A.getAttribute("height"));
            A.setAttribute("x", -N / 2), A.setAttribute("y", -M / 2);
          }
          var L = (m * Math.PI) / (C / 2);
          m++;
          var E = Math.cos(L) * b,
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    for (
      var g = c.w * (100 / r), p = c.h * (100 / r), f = o, u = l, m = [];
      f < s + o;
  ...
  (OrgChart._importSetColumnNames = function (t, e) {
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
      ...
      for (var f = 0; f < t.length; f++) {
        ...
        O.appendChild(u), g.appendChild(O);
      }
      ...
      for (f = 0; f < t.length; f++) {
        ...
        O.appendChild(u), b.appendChild(O);
      }
    ...
    if (n.draggable) {
      ...
      var O = function (t, e) {
          if (null != t) {
            ...
            for (
              var r = OrgChart.getStParentNodes(o.getNode(c)), i = 0;
              i < r.length;
              i++
            ) {
          ...
          if (p) {
            ...
            if (s.left || s.right || s.up || s.down) {
              ...
              if (null != c) {
                ...
                for (
                  var A = o.getNode(c), N = OrgChart.getStParentNodes(A), M = 0;
                  M < N.length;
                  M++
                ) {
                  var L = o.getNodeElement(N[M].id);
        ...
        b = function (e) {
          if (
            ...
            return (
              ...
              void (
                t._dragEventFired && OrgChart.events.publish("drop", [s, n.id])
              )
            );
          var i = s.getNode(o);
          if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id]))
            return m(o, l), h.removeChild(u), void (s._gragStartedId = null);
  ...
  (OrgChart.manager._initNode = function (t, e, r, i, a, n, o) {
    ...
    for (var p = 0; p < t.childrenIds.length; p++) {
      ...
      if (
        (OrgChart.manager._setCollpasedProperty(f, g, c, a, h, i, d),
        !f.collapsed)
      ) {
    ...
    if (
      ...
      for (p = 0; p < t.stChildrenIds.length; p++) {
        ...
        (t.tags && t.tags.has("filter")) ||
          ((f.stParent = t), t.stChildren.push(f));
      }
  ...
  (OrgChart.manager._iterate = function (t, e, r, i, a, n, o, l, s, h, c, d) {
    ...
    if (
      ...
      if (
        ...
        ((OrgChart.MIXED_LAYOUT_ALL_NODES &&
          p.length > 1 &&
          p.length == e.parent.children.length - f - u) ||
    ...
    for (b = 0; b < e.children.length; b++)
      OrgChart.manager._iterate(t, e.children[b], r, i, a, n, o, l, s, h, c, d);
  }),
  (OrgChart.manager.__createNodes = function (t, e, r, i, a, n, o, l) {
    for (var s = r.nodes, h = [], c = 0; c < s.length; c++) {
      ...
      var p = OrgChart._getTemplate(d, r.tags, r.template),
        f = new OrgChart.node(g.id, g.pid, d, p);
    ...
    for (c = 0; c < h.length; c++) {
      var u = h[c],
        ...
        C = t[f.stpid],
        b = t[f.pid];
      if ((C || (f.stpid = null), b || (f.pid = null), C)) {
        var O = n ? n[C.id] : null;
        O && (C.min = O.min), C.stChildrenIds.push(f.id);
      } else
        b
  ...
  (OrgChart.manager._createNodes = function (t) {
        ...
        if (d) {
          ...
          if (!f) {
            if (!OrgChart.isNEU(d.pid))
              (j = (O = l[d.pid]).childrenIds.indexOf(d.id)) > -1 &&
    ...
    for (c = 0; c < s.length; c++)
      OrgChart.manager._iterate(s[c], s[c], l, 0, _, w, k, S, "", m, I, t);
    ...
    for (c = 0; c < I.length; c++) {
      ...
      for (x = 0; x < C.children.length; x++) {
        (z = C.children[x]).isAssistant
          ...
          ? ((z.isPartner = 2), (z.children = []), M.push(z.id))
          : -1 == z.tags.indexOf("partner") || E % 2
          ? -1 != z.tags.indexOf("partner") && E % 2
            ? ((z.isPartner = 2), (z.children = []), M.push(z.id), E++)
            : z.parentPartner
            ? (L[z.parentPartner.id] || (L[z.parentPartner.id] = []),
              L[z.parentPartner.id].push(z.id))
            : A.push(z.id)
          : ((z.isPartner = 1), (z.children = []), N.push(z.id), E++);
      }
      C.children = [];
      var H = [];
      for (x = 0; x < N.length; x++) {
        L[(z = l[N[x]]).id] ? C.children.push(z) : C.children.splice(0, 0, z);
        for (var R = 0; R < z.childrenIds.length; R++) H.push(z.childrenIds[R]);
      }
      var F = [];
      for (x = 0; x < M.length; x++) {
        L[(z = l[M[x]]).id] ? C.children.push(z) : C.children.splice(0, 0, z);
      ...
      for (x = M.length - 1; x >= 0; x--)
        if (L[M[x]])
          for (u = 0; u < L[M[x]].length; u++)
            C.children.push(l[L[M[x]][u]]),
              T++,
              -1 == U.indexOf(M[x]) && U.push(M[x]);
      ...
      for (x = 0; x < N.length; x++)
        if (L[N[x]])
          for (u = 0; u < L[N[x]].length; u++)
            C.children.push(l[L[N[x]][u]]),
              B++,
      ...
      (C.partnerSeparation =
        Math.max(U.length, P.length) * e.partnerChildrenSplitSeparation +
    ...
    for (c = 0; c < k.length; c++) {
      if (
        ...
        for (x = 0; x < C.subLevels; x++) {
          ...
          if ((OrgChart.manager._initDinamicNode(D, C.lcn), (O = C.parent)))
            (j = O.children.indexOf(C)) > -1 &&
              (O.children.splice(j, 1), O.children.splice(j, 0, D)),
              D.children.push(C),
              (D.parent = O),
              (C.parent = D),
              (l[D.id] = D);
    ...
    for (var Y in w) {
      ...
      for (x = O.children.length - 1; x >= 0; x--) {
        (z = O.children[x]).isAssistant
          ? ((z.parent = null), O.children.splice(x, 1), q.splice(0, 0, z.id))
          : z.isPartner ||
            (z.parent &&
              S[z.parent.id] &&
              D &&
      ...
      if (q.length % 2) {
        var X = l[q[q.length - 1]],
          V = new OrgChart.node(X.id + "_mirror", O.pid, [], "mirror");
        ...
        if (
          ...
          if (
            ...
            for (c = nt.length - 1; c >= 0; c--) {
              (O = (z = l[nt[c]]).parent), (z.layout = OrgChart.mixed);
              for (x = O.children.length - 1; x >= 0; x--)
                if (z.id == O.children[x].id) {
                  O.children.splice(x, 1);
                  break;
                }
              if (c > 0) {
            ...
            for (c = rt.childrenIds.length - 1; c >= 0; c--) {
              for (z = l[rt.childrenIds[c]], x = 0; x < O.children.length; x++)
                O.children[x].id == z.id && O.children.splice(x, 1);
              if (
                ((z.parent = null),
            ...
            for ($ = 1, x = lt.length - 1; x >= 0; x--)
              if (x % 2 && x != lt.length - 1) {
                G = new OrgChart.node(O.id + "_split_" + $, it.id, [], "split");
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
      ...
      if (
        ...
        if ((u = e[n.id])) {
          for (
            d = t.parent;
            null != d && -1 == n.ids.indexOf(t.id) && -1 == n.ids.indexOf(d.id);
        ...
        if (
          (null != (f = l[t.id]).x && null != f.y && (c = { x: f.x, y: f.y }),
          (p = e[n.id]) && p == t)
        )
          (d = t.parent) &&
            d.id == n.id &&
        ...
        var f, u;
        if (
          (!(f = l[t.id]) || (OrgChart.isNEU(f.x) && OrgChart.isNEU(f.y))) &&
          n
        ) {
          if ((u = e[n.id])) {
  ...
  (OrgChart.manager._verticalAssistantIterate = function (t, e) {
    ...
    if (t.isAssistant && t.isSplit && t.children.length) {
      ...
      if (h.length) {
        for (
          var d = h[h.length - 1], g = h[0], p = t.children.length - 1;
          p >= 0;
          p--
        ) {
          var f = t.children[p];
  ...
  (OrgChart.ui = {
    ...
    expandCollapseBtn: function (t, e, r, i, a) {
      ...
      var f = { html: n, node: e };
      return OrgChart.events.publish("renderbuttons", [t, f]), f.html;
    },
          ...
          (m = t.children[u]).parentPartner
            ? ((f.ppnodes[m.id] = m.parentPartner),
              ...
              1 == m.parentPartner.isPartner
                ? (-1 == f.rightIds.indexOf(m.parentPartner.id) &&
                    f.rightIds.push(m.parentPartner.id),
                  (f.indexes[m.id] = f.rightIds.indexOf(m.parentPartner.id)),
                  f.firstRight || (f.firstRight = m))
                : 2 == m.parentPartner.isPartner &&
                  (-1 == f.leftIds.indexOf(m.parentPartner.id) &&
                    f.leftIds.push(m.parentPartner.id),
                  (f.indexes[m.id] = f.leftIds.indexOf(m.parentPartner.id)),
                  (f.lastLeft = m)))
            : m.isPartner ||
              ((f.lastLeft = m), f.firstRight || (f.firstRight = m));
        }
    ...
    _linkPpTop: function (t, e, r, i, a, n) {
      ...
      return (
        (s = c.mid),
        OrgChart.ui._linkTopToBottom({ x: d, y: l, w: 0, h: 0 }, r, n, 0, s)
      );
    },
    _linkPpBottom: function (t, e, r, i, a, n) {
      ...
      return (
        (s = c.mid),
        OrgChart.ui._linkBottomToTop({ x: d, y: l, w: 0, h: 0 }, r, n, 0, s)
      );
    },
    _linkPpLeft: function (t, e, r, i, a, n) {
      ...
      return (
        (l = c.mid),
        OrgChart.ui._linkLeftToRight({ x: h, y: d, w: 0, h: 0 }, r, n, 0, l)
      );
    },
    _linkPpRight: function (t, e, r, i, a, n) {
      ...
      return (
        (l = c.mid),
        OrgChart.ui._linkRightToLeft({ x: h, y: d, w: 0, h: 0 }, r, n, 0, l)
      );
    },
      ...
      if (e.sl == n.sl)
        ...
        for (var m = e; null == h; ) {
          ...
          if (
            (b.id == n.id
              ? (h = b)
              : OrgChart._intersects(b, u, t.config) &&
                ((u = OrgChart._addPoint(b, s, t.config, u, c)), (C = !0)),
            b.id != n.id)
          ) {
            for (; O; ) {
              if (O.id == n.id) {
              ...
              OrgChart._intersects(O, u, t.config) &&
                ((u = OrgChart._addPoint(O, s, t.config, u, c)), (C = !0)),
                (O = O.leftNeighbor);
            }
            for (; v; ) {
              if (v.id == n.id) {
              ...
              OrgChart._intersects(v, u, t.config) &&
                ((u = OrgChart._addPoint(v, s, t.config, u, c)), (C = !0)),
                (v = v.rightNeighbor);
            }
          }
          if (!C) {
            ...
            if (b.parent)
              switch (
                ...
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (x = b.parent.x - f * (2 / 3)), (y = s[s.length - 1][1]);
              }
            s.push([x, y]);
          }
          m = b;
